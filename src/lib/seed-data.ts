...
export const seedUsers: User[] = [
  { id: "user-1", name: "Vincent Lim", email: "vincent@collectivep.com", avatarColor: "#8b46ff", role: "admin" },
  { id: "user-2", name: "Michael Chua", email: "michael@collectivep.com", avatarColor: "#ff6b4a", role: "admin" },
  { id: "user-3", name: "Lim Lee Lee", email: "leelee@collectivep.com", avatarColor: "#14b8a0", role: "manager" },
  { id: "user-4", name: "Douglas Danapal", email: "douglas@collectivep.com", avatarColor: "#ffd633", role: "manager" },
  { id: "user-5", name: "Abu Sahl (Iqbal)", email: "iqbal@collectivep.com", avatarColor: "#8b46ff", role: "member" },
  { id: "user-6", name: "Ryan Putra", email: "ryan@collectivep.com", avatarColor: "#ff6b4a", role: "member" },
  { id: "user-7", name: "Stephanie Fam", email: "stephanie@collectivep.com", avatarColor: "#14b8a0", role: "member" },
  { id: "user-8", name: "Jeffrey Lim", email: "jeffrey@collectivep.com", avatarColor: "#ffd633", role: "member" },
];
